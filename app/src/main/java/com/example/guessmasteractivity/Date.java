...
public class Date
{
    ...
    {
    	String[] monDayYear = strDate.split("-");
    	int monthInt = Integer.parseInt(monDayYear[0]);
    	int dayInt = Integer.parseInt(monDayYear[1]);
    	int yearInt = Integer.parseInt(monDayYear[2]);
...
//          return false;
    ...
    /**
     * Mutator that set the class's month,
     * day, and year attributes.
     * @param  monthString  the name of month in String format
